...
//
// 과목 카드의 목적지 `/mypage/wrong-notes/[slug]`(과목 오답노트)와 섞어풀기 `/subjects/[slug]/mix`
// 는 Phase 2·3 스트림 — 아직 없으면 expo-router 가 +not-found 로 보낸다(설계서 §5 미매칭 행).
// 이 파일은 목록 수준(과목 요약 카드)만 그린다.
