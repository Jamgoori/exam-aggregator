...
const SUBJECT_ALIASES = {
  ...
  "인사·조직론": "인사ㆍ조직론",
  // 국회직 PDF 헤더에서 자간 제거 과정에 "및" 앞뒤 공백까지 같이 지워짐
  자동차구조원리및도로교통법규: "자동차구조원리 및 도로교통법규",
  조경계획및설계: "조경계획 및 설계",
  // 국회직 8급이 2025년부터 국어/영어 대신 PSAT형 언어논리/상황판단/자료해석
  // 영역으로 바뀌었는데, PDF 헤더에는 "영역"이 붙어 나오고 DB 과목명에는 없음.
  언어논리영역: "언어논리",
  상황판단영역: "상황판단",
  자료해석영역: "자료해석",
  // 군무원 파일명은 공백 없이 "네트워크보안"으로 표기하지만 DB는 "네트워크 보안".
  네트워크보안: "네트워크 보안",
};
