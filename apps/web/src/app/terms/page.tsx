    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 px-4 py-12 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
      ...
      <Section title="제8조 (서비스의 변경과 중단)">
        <ul className="list-disc pl-5">
          ...
          <li>
            기출문제·정답 열람과 다운로드, CBT 풀이는 무료로 제공됩니다. 오답노트, 복습,
            AI 약점 진단과 일정 횟수를 넘는 해설 열람은 유료 멤버십 기능입니다.
          </li>
        </ul>
      </Section>
      ...
      <Section title="제9조 (유료 멤버십)">
        <ul className="list-disc pl-5">
          ...
          <li>
            결제일로부터 7일 이내에 멤버십 전용 기능을 이용하지 않은 경우 전액 환불합니다.
            이미 이용한 경우에는 이용한 기간에 해당하는 금액과 환불 수수료를 뺀 금액을
            환불합니다.
          </li>
          <li>
          ...
          <li>
            무료 체험은 계정당 1회 제공되며, 체험 기간이 끝나도 자동으로 결제되지 않습니다.
          </li>
        </ul>
      </Section>
