          ...
          {papers.map((p) => {
            ...
            return (
              <Link
                ...
                className="group flex flex-col gap-2 rounded-xl border border-zinc-200 p-4 transition-colors hover:border-blue-300 hover:bg-blue-50/40"
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium leading-snug group-hover:text-blue-600">
                    {p.paper.title}
                  </span>
                  <ChevronRight
                    size={16}
                    className="ml-auto shrink-0 text-zinc-300 group-hover:text-blue-600"
                  />
                </div>
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-zinc-500">
                  ...
                  {pctLabel && (
                    <span>
                      최근{" "}
                      <span className="font-semibold text-zinc-800">{pctLabel}</span> (
