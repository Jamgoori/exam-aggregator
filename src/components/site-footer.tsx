...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-16 border-t border-zinc-100 dark:border-zinc-800">
      <div className="mx-auto flex max-w-5xl flex-col gap-2 px-4 py-8 text-xs text-zinc-400 dark:text-zinc-500">
