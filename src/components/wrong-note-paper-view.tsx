      ...
      <div className="-mx-4 flex gap-2 overflow-x-auto px-4 pb-1 sm:mx-0 sm:flex-wrap sm:px-0">
        ...
        {rounds.map((r) => (
          ...
          >
            ...
            <span className={view === r.attemptId ? "text-blue-100" : "text-zinc-400"}>
              {" "}
      ...
      {selectedRound ? (
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          {questions.some((q) => q.resolved) && (
            <label className="flex cursor-pointer select-none items-center gap-1.5 text-xs font-medium text-zinc-600">
              <input
                type="checkbox"
